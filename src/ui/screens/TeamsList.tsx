...
export function TeamsList() {
  ...
  /* One read for every team's headcount, where this used to fan out one roster read
     per team and wait for them all. The whole `player` kind is a single cache entry —
     see `queries.ts` — so the count is a tally over it. */
